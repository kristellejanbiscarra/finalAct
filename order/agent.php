...
if ($result = $mysqli->query("SELECT * FROM agents ORDER BY AGENT_CODE ASC")) {
    ...
    echo '<th colspan="2" align="center"><a href="addagent1.php" class="button-link">ADD RECORD</a></th>';
	 ...
	 echo '<td><a href="view_agent.php?AGENT_CODE=' . $row[0] . '" class="button-link">VIEW</a></td> <td><a href="update_agent.php?AGENT_CODE=' . $row[0] . '" class="button-link">EDIT</a></td>';
	  echo '</tr>';
        }
     echo '</table>';
