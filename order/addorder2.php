...
<h2 class="styled-heading">ORDERS RECORD</h2>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "ORDER NUMBER: " . $ORD_NUM . "<br>";
echo "ORDER AMOUNT: " . $ORD_AMOUNT . "<br>";
echo "ADVANCE AMOUNT: " . $ADVANCE_AMOUNT . "<br>";
echo "ORDER DATE: " . $ORD_DATE . "<br>";
echo "CUSTOMER CODE: " . $CUST_CODE . "<br>";
echo "AGENT_CODE: " . $AGENT_CODE . "<br>";
echo "ORDER DESCRIPTION: " . $ORD_DESCRIPTION . "<br><br>";
